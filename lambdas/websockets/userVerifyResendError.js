...
exports.handler = async event => {
    ...
    try {
        ...
        replyMessage.message.displayMessage = 'Noting ERROR Resend of User Verification';
        ...
        console.log('\n', path.basename(__filename), '[42] : Error in Parsing Payload :' )
        console.log('\n', e.stack)

        return { statusCode: 500, body: e.stack };
    }

    return Responses._200({ success: true, message: 'user-verify-resend-error' });
};
