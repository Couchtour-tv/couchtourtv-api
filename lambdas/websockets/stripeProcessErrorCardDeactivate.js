...
exports.handler = async event => {
    ...
    try {
        ...
        console.log('\n************** [stripeProcessErrorCardDeactivate.js] [31] payload Recevied:', postData );
        try {
            ...
            replyMessage.action = 'stripe-process-error-card-deactivate-resp-success';
        ...
        // error catch: making purchase request
            ...
            replyMessage.action = 'stripe-process-error-card-deactivate-resp-error';
            replyMessage.message.displayMessage = 'purchase and transaction records NOT updated';
            replyMessage.message.transactionId = transactionId;
            replyMessage.message.acquiredId = acquiredId;

            console.log('\n************** [stripeProcessErrorCardDeactivate.js] [96] : Error in Processing' );
            console.log('\n', e.stack);
        }
        ...
        try {
            ...
            console.log('\n************** [stripeProcessErrorCardDeactivate.js] [133]: Socket Send to connectcionId: ')

        // error catch: responding with socket call
        } catch (e) {

            console.log('\n************** [stripeProcessErrorCardDeactivate.js] [138] : Error Return Socket Message to Client:' );
            console.log('\n', e.stack);
    ...
    // error catch: json payload parsing
        ...
        console.log('\n************** [stripeProcessErrorCardDeactivate.js] [78] : Error in Parsing Payload :' );
        console.log('\n', e.stack);
        return { statusCode: 500, body: e.stack };

    }
    return Responses._200({ success: true, message: 'stripe-process-error-card-deactivate' });
};